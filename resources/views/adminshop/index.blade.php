    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="dataTable_wrapper">
                ...
                <form action="/adminshop/index" method='get' >
                ...
                <table id="table" class="table table-striped table-bordered table-hover dataTable no-footer" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info">
                    ...
                    @endforeach
                        <tr>
                            <td colspan='9'><button style='float:right' class="btn ore btn-primary">接单</button></td>
                        </tr>
                        </tbody>
                </table>
                @endforeach
                  ...
                  @else
                    <div class="col-sm-9 col-md-offset-3 "  style="background:url('/upload/14.jpg') no-repeat;width:300px;height:250px">  
                    <font size="5" color="#FF0000">别看了,啥也没有啊</font> 
                    </div>
                 @endif   
                </div>
            </div>
...
<script type="text/javascript">
        ...
        $('.ore').click(function(){
         var id = $(this).parents('tr').siblings('.gradeA').find('.sorting_1').html();
            // alert(id);
         var a = $(this);  
            $.ajax({
                url:'/adminshop/ores',
